...
"""
python3 -m deep_rl_zoo.prioritized_dqn_v1.eval_agent --environment_name=Seaquest --run_name original_alpha0.1 \
    --load_checkpoint_file=checkpoints/ \
    --num_eval_steps 1000
"""
...
flags.DEFINE_integer('num_iterations', 5, 'Number of evaluation iterations to run.')
...
def main(argv):
    ...
    checkpoint = PyTorchCheckpoint(environment_name=FLAGS.environment_name, agent_name=f"PER-DQN-{FLAGS.run_name}-{FLAGS.environment_name}", restore_only=True)
